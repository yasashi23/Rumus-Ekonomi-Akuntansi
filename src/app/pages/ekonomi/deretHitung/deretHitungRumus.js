  ...
  return (
    <div>
        <div className="contHitung mt-5">
            <h1 className='text-center text-xl font-semibold'>Hitung (deret hitung) Disini</h1>
...
export default dynamic (() => Promise.resolve(DeretHitungRumus), {ssr: false})